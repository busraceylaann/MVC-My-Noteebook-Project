    ...
    public class MailHelper
    {
        ...
        public static bool SendMail(string body, List<string> to, string subject, bool isHtml = true)
        {
            ...
            try
            {
                ...
                message.From = new MailAddress(Confighelpercs.Get<string>("MailUser"));
                ...
                using (var smtp = new SmtpClient(
                    Confighelpercs.Get<string>("MailHost"),
                    Confighelpercs.Get<int>("MailPort")))
                {
                    smtp.EnableSsl = true;
                    smtp.Credentials =
                        new NetworkCredential(
                            Confighelpercs.Get<string>("MailUser"),
                            Confighelpercs.Get<string>("MailPass"));
